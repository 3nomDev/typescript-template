...
import { addUserLogin, editUserInfo, getUserByEmail, userSelector } from '../../features/authSlice';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEye } from '@fortawesome/fontawesome-free-solid';
import { IconProp } from '@fortawesome/fontawesome-svg-core';
import { addNotification } from '../../features/notifications/notificationSlice';
import { useRouter } from 'next/router';
import { loadApplicationByGuid } from '../../features/dealerDashboardSlice';
...
let userData
if(values.Password ){
hashedPass = bcrypt.hashSync(values.Password, saltRounds);
userData = { ...values, Password: hashedPass };
} 
else {

    userData={...values, Password: userProfile?.Password}
}
...
const getUserInfoByEmailAddress = async () => {
        let result = await dispatch(getUserByEmail(user?.EmailAddress));
  ...
  {userProfile &&   <div className={styles.wrapper}>
      ...
      <div className={styles.dealerForm}>
        ...
        //   validationSchema={validationSchema}
          initialValues={{...userProfile, Password:''}}
        >
